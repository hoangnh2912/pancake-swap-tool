...
const prisma = new PrismaClient({
    datasourceUrl: app.isPackaged ? `file:${path.join(path.dirname(process.execPath), 'prisma', 'scan-wallet.sqlite')}` : `file:${path.join(app.getAppPath(), 'prisma', 'scan-wallet.sqlite')}`,
});
